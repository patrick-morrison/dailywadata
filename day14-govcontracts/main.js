...
const CONFIG = {
    ...
    AGENCY_COLORS: {
        'Arts and Culture Trust': '#2E1747',
        'Botanic Gardens and Parks Authority': '#0B6A6B',
        'Central Regional TAFE': '#01ADEF',
        'Child and Adolescent Health Service': '#0177BF',
        'Department of Biodiversity, Conservation and Attractions': '#D14210',
        'Department of Communities': '#2BBCCD',
        'Department of Creative Industries, Tourism and Sport': '#0E8281',
        'Department of Education': '#A40A66',
        'Department of Energy and Economic Diversification': '#041049',
        'Department of Fire and Emergency Services': '#00294D',
        'Department of Health (Royal Street)': '#005B38',
        'Department of Housing and Works': '#F4F4F4',
        'Department of Justice': '#6A003A',
        'Department of Mines, Petroleum and Exploration': '#A3291E',
        'Department of Planning, Lands and Heritage': '#005F73',
        'Department of Primary Industries and Regional Development': '#943220',
        'Department of Training and Workforce Development (DTWD)': '#F37239',
        'Department of Transport and Major Infrastructure': '#007DBA',
        'Department of Treasury and Finance': '#076E7B',
        'Department of Water and Environmental Regulation': '#006890',
        'Department of the Premier and Cabinet': '#D8EEEE',
        'Department of the Registrar, WA Industrial Relations Commission': '#B0EDFC',
        ...
        'Lotterywest': '#0073BC',
        'Main Roads Western Australia': '#d14210',
        'Mental Health Commission': '#00874D',
        'Metropolitan Cemeteries Board': '#1A548F',
        'MyLeave': '#16A6B8',
        'National Trust of Western Australia': '#71BF4B',
        'North Metropolitan Health Service': '#990057',
        'North Metropolitan TAFE': '#D9272E',
        'North Regional TAFE': '#F57E20',
        'Office of the Auditor General for Western Australia': '#007aff',
        'Office of the Director of Public Prosecutions for WA': '#00527c',
        'Parliament Commissioner for Administrative Investigations': '#1F497D',
        'PathWest Laboratory Medicine WA': '#9e0228',
        'Programmed Facility Management': '#84BD00',
        'Public Sector Commission': '#B03C8D',
        'Public Transport Authority': '#009999',
        ...
        'State Solicitor\'s Office': '#003044',
        'VenuesWest': '#02C3FB',
        'WA Country Health Service': '#005B94',
        'Western Australia Police Force': '#024B99',
        'Western Australian Electoral Commission': '#BB9207',
        'Western Australian Museum': '#E61255',
        'Western Australian Tourism Commission': '#2B5B5F',
        'Workcover Western Australia': '#113F60'
    }
};
